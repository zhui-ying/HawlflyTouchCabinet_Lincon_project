...
#define OS_CPU_HOOKS_EN           10u   /* uC/OS-II hooks are found in the processor port files         */

#define OS_DEBUG_EN               0u   /* Enable(1) debug variables   可生成调试信息     */
...
#define OS_MAX_EVENTS             9u   /* Max. number of event control blocks in your application      */
...
#define OS_TASK_PFILERO_EN        1u   /*     Include variables in OS_TCB for profiling 神马情况，写错了吗？*/
